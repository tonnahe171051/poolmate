...
namespace PoolMate.Api.Data.Migrations
{
    ...
    [Migration("20251217073743_DbForOrganizer")]
    partial class DbForOrganizer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoolMate.Api.Models.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("NextWinnerMatchId")
                        .HasColumnType("int");

                    b.Property<int?>("Player1SourceMatchId")
                        .HasColumnType("int");

                    b.Property<string>("Player1SourceType")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");

                    b.Property<int?>("Player1TpId")
                        .HasColumnType("int");

                    b.Property<int?>("Player2SourceMatchId")
                        .HasColumnType("int");

                    b.Property<string>("Player2SourceType")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");

                    b.Property<int?>("Player2TpId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PoolMate.Api.Models.Tournament", b =>
                {
                    ...
                    b.Property<int?>("AdvanceToStage2Count")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Stage1Ordering")
                        .HasColumnType("int");

                    b.Property<int>("Stage2Ordering")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PoolMate.Api.Models.Match", b =>
                {
                    b.HasOne("PoolMate.Api.Models.Match", null)
                        .WithMany()
                        .HasForeignKey("NextLoserMatchId")
